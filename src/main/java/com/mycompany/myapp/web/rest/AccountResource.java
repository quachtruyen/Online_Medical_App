...
import com.mycompany.myapp.web.rest.vm.ManagedUserInfoVM;
import java.util.*;
...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserInfoVM managedUserVM) {
     ...
     */
    @GetMapping("/account")
    public UserInfoDTO getAccount() {
        return userService.getUserWithInfo();
    }
     ...
     */
    @PostMapping("/account")
    public void saveAccount(@Valid @RequestBody UserInfoDTO userDTO) {
    ...
    private static boolean isPasswordLengthInvalid(String password) {
        return (
            ...
            password.length() < ManagedUserInfoVM.PASSWORD_MIN_LENGTH ||
            password.length() > ManagedUserInfoVM.PASSWORD_MAX_LENGTH
        );
    }
}
